...
if(isset($_POST['add_cat'])){
    $name=$_POST['name'];
    if($conn->query("insert into category(category_name)values('$name')" )){
        ?><script>alert('Category Added')</script><?php
    }else{
        ...
        <div class="category">
            <div class="table_side">
                        <table id="product_table" class="table table-striped"style="width:100%;">
                            ...
                            <tbody>
                                <?php
                                    $productresult=$conn->query("select * from category");
                        ...
                        <div class="added_side">
                            <form action="application.php"method="POST"style="margin-left:10%;">
                        <div class="form-group"style="width:70%">
                            <input type="text"name="name"placeholder="Category Name"class="form-control"required>
                            </div>
                            <input type="submit"value="ADD"class="btn btn-primary"name="add_cat">
                            </form>
                        </div>
                    </div>
